export default function Terms() {
    return (
        <div>
            ...
            <li>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to robots-validator.</li>
            ...
            <li>Free Trial refers to a limited period of time that may be free when purchasing a Subscription.
            ...
            <li>Website refers to robots-validator, accessible from https://www.robots-validator.com/</li>
            <li>You mean’s the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
            </ul>
            ...
            <h4>Services Usage Limits</h4>
            <p>You agree not to reproduce, duplicate, copy, sell, resell or exploit any portion of the Service, use of the Service, or access to the Service without the Company's express written permission.</p>
            <p>You agree not to use or access the backend of the Service directly without using the Service's user interface (Website or frontend).</p>
            ...
            <p>You assign all rights, title and interest in any Feedback You provide the Company. If for any reason such assignment is ineffective, You agree to grant the Company a non-exclusive, perpetual, irrevocable, royalty free, worldwide right and licence to use, reproduce, disclose, sub-license, distribute, modify and exploit such Feedback without restriction.</p>
            ...
            <p>We reserve the right, at Our sole discretion, to modify or replace these Terms at any time. Changes in these Terms will be posted on this page. You are advised to check this page regularly to view the most recent Terms and Conditions.</p>
            <p>By continuing to access or use Our Service after those revisions become effective, You agree to be bound by the revised terms. If You do not agree to the new terms, in whole or in part, please stop using the website and the Service.</p>


            <h3>Contact Us</h3>

            <p>If you have any questions about these Terms and Conditions, You can contact us: https://www.robots-validator.com/</p>
        </div>
    )
}